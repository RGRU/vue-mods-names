...
** Переваги **
1. Використовуючи плагін, кожен компонент вашої програми отримує можливість приймати модифікатори через props: mods. (Вам більше не потрібно додавати цю поведінку в окремі компоненти)
2. Ваш код стає менше. Вся робота з модифікаторами прихована в плагіні.
3. У будь-який компонент можна передавати один модифікатор рядком або будь-яку кількість модифікаторів в масиві.
4. Налаштування використання базового класу (дивіться розділ `" просунуте використання "`)
